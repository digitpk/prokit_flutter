                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          SizedBox(height: 10),
                          Align(alignment: Alignment.topLeft, child: Text("Sedan Series", style: boldTextStyle())).paddingOnly(left: 16),
                          SizedBox(height: 10),
                          Row(
                            children: [
                          ...
                          Align(
                            ...
                            child: Text(listOfCarPrize[index], style: boldTextStyle()),
                          ).paddingOnly(left: 16),
                        ],
                      ),
                    ],
                    ...
                    return Container(
                      ...
                      child: Observer(
                        builder: (context) => ListTile(
                          title: Text("${logi.searclist[index]}", style: primaryTextStyle()),
                          trailing: IconButton(
                            onPressed: () {

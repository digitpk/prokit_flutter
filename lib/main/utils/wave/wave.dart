...
class _CustomWavePainter extends CustomPainter {
  ...
  _CustomWavePainter(this.colorMode, {this.color, this.gradient, this.gradientBegin, this.gradientEnd, this.blur, this.heightPercentange, this.waveFrequency, this.wavePhaseValue, this.waveAmplitude, Listenable? repaint}) : super(repaint: repaint);

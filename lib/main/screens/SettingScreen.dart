                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      SettingContainerWidget(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [Image.asset('images/app/ic_documentation.png', height: 30, width: 30, color: appColorPrimary), 8.height, Text(language!.lblDocumentation, style: boldTextStyle(size: 16)), 8.height, Text(language!.lblSetupConfiguration, style: secondaryTextStyle(size: 12))],
                        ),
                      ).onTap(() {
                      ...
                      SettingContainerWidget(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [Image.asset('images/app/ic_change_log.png', height: 30, width: 30, color: appColorPrimary), 8.height, Text(language!.lblChangeLog, style: boldTextStyle(size: 16)), 8.height, Text(language!.lblVersionHistory, style: secondaryTextStyle(size: 12))],
                        ),
                      ).onTap(() {
                      ...
                      SettingContainerWidget(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [Image.asset('images/app/ic_share.png', height: 30, width: 30, color: appColorPrimary), 8.height, Text(language!.lblShareApp, style: boldTextStyle(size: 16)), 8.height, Text(language!.lblShareWithFriends, style: secondaryTextStyle(size: 12))],
                        ),
                      ).onTap(() async {
                      ...
                      SettingContainerWidget(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [Image.asset('images/app/ic_rate_app.png', height: 30, width: 30, color: appColorPrimary), 8.height, Text(language!.lblRateUs, style: boldTextStyle(size: 16)), 8.height, Text(language!.lblRateGooglePlayStore, style: secondaryTextStyle(size: 12))],
                        ),
                      ).onTap(() {
                        getPackageInfo().then((value) async {
                          String package = value.packageName.validate();
                      ...
                      SettingContainerWidget(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [Icon(MaterialCommunityIcons.google_translate, color: appColorPrimary, size: 30), 8.height, Text(language!.lblLanguage, style: boldTextStyle(size: 16)), 8.height, Text(language!.lblSupportLanguage, style: secondaryTextStyle(size: 12))],
                        ),
                      ).onTap(() async {
